...
/* package bomberman-0.1.0.0 */
#ifndef VERSION_bomberman
#define VERSION_bomberman "0.1.0.0"
#endif /* VERSION_bomberman */
#ifndef MIN_VERSION_bomberman
#define MIN_VERSION_bomberman(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_bomberman */
...
#define CURRENT_COMPONENT_ID "bomberman-0.1.0.0-EGZwZfCIIq4KTZWYgfPMde-bomberman"
